...
import { Levels, LevelConst } from '../lobby/lobby';
...
export class HighScoreWorld extends World {
    ...
    generateMap() {
        ...
        const scores = Levels.filter(l => l != LevelConst.HighScore).map(l => {return {players: HighScoreManager.loadForGame(l) || {}, gameId: LevelConst[l]};});
